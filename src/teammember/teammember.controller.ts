...
export class TeammemberController {
    ...
    teamsearch(@Headers() headers): any {
      ...
      return TeammemberService.SearchMemberByAuth(AuthKey).pipe(
        switchMap((data) => {
          var team = new Array()
          ...
          //   return TeamService.SearchTeam(team[i]).pipe(
          //     map((data)=>{
          //       console.log(data.teamname)
          //        teamname[i]=data.teamname
          //     }),
          //   )
          // }
          // console.log(teamname+'22222222')
          // return teamname
        }),
